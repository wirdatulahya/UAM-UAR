...
<head>
    ...
    <meta name="description" content="User Access Matrix & Review — PT Telkom Infrastruktur Indonesia internal portal">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>@yield('title', 'UAM-UAR') — PT Telkom Infrastruktur Indonesia</title>
