                        ...
                        <tbody>
                                ...
                                <td style="padding:1rem 1.25rem;vertical-align:middle;text-align:center;" onclick="event.stopPropagation();">
                                    <div class="dropdown" onclick="event.stopPropagation();">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" style="border-radius:10px;box-shadow:0 4px 12px rgba(0,0,0,.08);border-color:var(--border);">
                                            <li>
                                                <a class="dropdown-item" href="{{ route('access-matrix.sap', ['request_id' => $req->id, 'source' => 'approval']) }}" style="font-size:.85rem;display:flex;align-items:center;gap:.5rem;padding:.5rem 1.25rem;">
                            ...
                            <tr>
                                <td colspan="7" style="padding:4rem 1rem;text-align:center;">
                                    <div style="width:72px;height:72px;background:linear-gradient(135deg,var(--secondary-light),#dbeafe);border-radius:20px;display:inline-flex;align-items:center;justify-content:center;margin:0 auto 1.1rem;box-shadow:0 4px 16px rgba(11,46,109,.08);">
                                        <i class="bi bi-inbox" style="font-size:1.8rem;color:var(--secondary);"></i>
                                    </div>
                                    <h3 style="font-size:1rem;font-weight:800;color:var(--secondary);margin-bottom:.3rem;">No requests found</h3>
...
<div class="modal fade" id="versionHistoryModal" tabindex="-1" aria-labelledby="versionHistoryModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content" style="border:none;border-radius:20px;box-shadow:0 24px 64px rgba(0,0,0,.14);">
            <div class="modal-header" style="border-bottom:1px solid var(--border);padding:1.4rem 1.75rem;background:linear-gradient(135deg,var(--secondary-light),#fff);border-radius:20px 20px 0 0;">
                <div style="display:flex;align-items:center;gap:.7rem;">
                    <div style="width:38px;height:38px;background:linear-gradient(135deg,var(--secondary-light),#bfdbfe);border-radius:12px;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 8px rgba(11,46,109,.12);">
                        <i class="bi bi-clock-history" style="color:var(--secondary);font-size:1rem;"></i>
                    </div>
                    <div>
                        <h5 class="modal-title" id="versionHistoryModalLabel" style="font-size:1rem;font-weight:800;color:var(--secondary);margin:0;letter-spacing:-.2px;">Version History</h5>
                        <div style="font-size:.73rem;color:var(--text-muted);">History for <strong id="versionHistoryAppName"></strong></div>
                    </div>
                </div>
